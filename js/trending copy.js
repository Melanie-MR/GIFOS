let carrouselContenedor = document.getElementById("gif__container");
...
function sliderMovement(n) {
    let imgTrendigns = document.getElementsByClassName("trending-card-slider"); // <- [img1, img2, img3]
    count = count + n;
